...
def test_filter_digital_data():
    assert filter_digital_data("Visa Platinum 7000792289606361") == 7000792289606361
    assert filter_digital_data("Счет 73654108430135874305") == 73654108430135874305
